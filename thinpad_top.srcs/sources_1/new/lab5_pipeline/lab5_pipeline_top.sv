...
module lab5_top_pipeline (
  ...
  logic if_id_stall_i, if_id_buble_i;
  logic id_exe_stall_i, id_exe_buble_i;
  logic exe_mem_stall_i, exe_mem_buble_i;
  logic mem_wb_stall_i, mem_wb_buble_i;

  logic if_flush_o, if_stall_o;
  logic id_flush_o, id_stall_o;
  logic exe_flush_o, exe_stall_o;
  logic mem_flush_o, mem_stall_o;
  ...
  // Wishbone Master signals with IF and MEM modules
  logic       if_wbm_cyc_o;
  logic       if_wbm_stb_o;
  logic       if_wbm_ack_i;
