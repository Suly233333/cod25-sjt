...
module lab3_tb;
  ...
  parameter BASE_RAM_INIT_FILE = "D:\\cod25\\lab2\\cod25-shenjt22\\thinpad_top.srcs\\sim_1\\new\\tb\\main.bin"; // BaseRAM 初始化文件，请修改为实际的绝对路径
  parameter EXT_RAM_INIT_FILE = "D:\\cod25\\lab2\\cod25-shenjt22\\thinpad_top.srcs\\sim_1\\new\\tb\\eram.bin";  // ExtRAM 初始化文件，请修改为实际的绝对路径
